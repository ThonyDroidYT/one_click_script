...
function start_menu(){
    ...
    green " =================================================="
    green " Trojan Trojan-go V2ray Script de instalación con un solo clic 2021-03-06 Actualizar.  Soporte del Sistema：centos7+ / debian9+ / ubuntu16.04+"
    red " *No utilice este script en ningún entorno de producción. No permita que otros programas ocupen los puertos 80 y 443."
    green " =================================================="
    green " 1. Instalar BBR-PLUS Aceleración 4-en-1 script"
    echo
    green " 2. CDN no es compatible para instalar troyanos y nginx "
    green " 3. Repare el certificado y continúe instalando el troyano "
    green " 4. Actualice el troyano a la última versión "
    red " 5. Desinstalar troyano y nginx "
    echo
    green " 6. La instalación de trojan-go y nginx no admite CDN, no abra websocket (compatible con el cliente troyano) "
    green " 7. Repare el certificado y continúe instalando trojan-go no es compatible con CDN, no abra websocket "
    green " 8. Instale trojan-go y nginx para admitir CDN y habilitar websocket (compatible con el cliente troyano pero no compatible con websocket) "
    green " 9. Repare el certificado y continúe instalando trojan-go para admitir CDN, abra websocket "
    green " 10. Actualice trojan-go a la última versión "
    red " 11. Desinstale trojan-go y nginx "
    echo
    green " 12. Instale v2ray o xray y nginx, soporte websocket tls1.3, soporte CDN "
    green " 13. Actualice v2ray o xray a la última versión "
    red " 14. Desinstale v2ray o xray y nginx "
    echo
    green " 15. Instale trojan + v2ray o xray y nginx al mismo tiempo, CDN no es compatible "
    green " 16. Actualice v2ray o xray y trojan a la última versión "
    red " 17. Desinstale troyano, v2ray o xray y nginx "
    green " 18. Instale trojan-go + v2ray o xray y nginx al mismo tiempo, CDN no es compatible "
    green " 19. Instale trojan-go + v2ray o xray y nginx al mismo tiempo, tanto trojan-go como v2ray admiten CDN"
    green " 20. Actualice v2ray o xray y trojan-go a la última versión "
    red " 21. Desinstale trojan-go, v2ray o xray y nginx "
    echo
    green " 28. Ver información como la configuración instalada y la contraseña de usuario "
    green " 29. Instale el panel de administración visual troyano y v2ray "
    green " 30. No instale nginx, solo instale troyano o v2ray o xray (xtls), puede elegir si desea instalar un certificado SSL "
    green " =================================================="
    green " 31. Instale OhMyZsh y el complemento zsh-autosuggestions, Micro editor y otro software "
    green " 32. La configuración se puede iniciar sesión como root "
    green " 33. Modificar el número de puerto de inicio de sesión SSH"
    green " 34. Establecer la zona horaria a la hora de Beijing "
    green " 41. Herramienta de prueba de velocidad de red de VPS y si VPS es compatible con la herramienta de prueba de Netflix "
    green " 0. Salir de la secuencia de comandos "
    echo
    read -p "Introduzca los números:" menuNumberInput
    case "$menuNumberInput" in
        1 )
            installBBR
        ;;
